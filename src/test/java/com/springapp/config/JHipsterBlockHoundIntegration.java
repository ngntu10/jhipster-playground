...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.springapp.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.springapp.security.DomainUserDetailsService", "createSpringSecurityUser");
